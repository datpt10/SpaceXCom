...
//    that the image requested fails to load.
    ...
    public void setmErrorImageResId(int errorImageResId) {
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        boolean isFullyWrapContent = getLayoutParams() != null
                && getLayoutParams().height == Gallery.LayoutParams.WRAP_CONTENT
                && getLayoutParams().width == Gallery.LayoutParams.WRAP_CONTENT;
        ...
        ImageLoader.ImageContainer newContainr = mImageLoader.get(mUrl, new ImageLoader.ImageListener() {
